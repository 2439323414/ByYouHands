...
public class Sosphone extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sosphone);
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                switch (i){
                    ...
                    case 1: intent = new Intent(Intent.ACTION_SENDTO);
                        ...
                        startActivity(intent);
                        break;
                    case 2: intent = new Intent(Sosphone.this,AddData.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.main_but:
                ...
                Intent intent = new Intent(Sosphone.this,AddData.class);
    ...
    public void DbUtil(){
        dao = ((TrackApplication)this.getApplication()).getDao();
    }
