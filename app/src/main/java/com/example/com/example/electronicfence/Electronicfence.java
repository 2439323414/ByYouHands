...
public class Electronicfence extends BaseActivity {
    ...
    public class SDKReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_ERROR)) {
                Toast.makeText(Electronicfence.this,"apikey验证失败，地图功能无法正常使用",Toast.LENGTH_SHORT).show();
            } else if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_OK)) {
                Toast.makeText(Electronicfence.this,"apikey验证成功",Toast.LENGTH_SHORT).show();
            } else if (s.equals(SDKInitializer.SDK_BROADCAST_ACTION_STRING_NETWORK_ERROR)) {
                Toast.makeText(Electronicfence.this,"网络错误",Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void init() {
        ...
        trace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Electronicfence.this, CreateFenceActivity.class);
    ...
    protected int getContentViewId() {
        return R.layout.activity_electronicfence;
    }
