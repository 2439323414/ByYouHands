...
public class Clock extends AppCompatActivity {
                ...
                new TimePickerDialog(Clock.this,
                        new TimePickerDialog.OnTimeSetListener()
                        {
                                                  ...
                                                  int minute)
                            {
                                ...
                                Intent intent = new Intent(Clock.this, CallAlarm.class);
                                ...
                                Toast.makeText(Clock.this,"设置闹钟时间为"+tmpS,
                                        Toast.LENGTH_SHORT)
                                        .show();
                            }
    ...
    private void InitDelete1(){
        ...
        delete1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                am =(AlarmManager)getSystemService(ALARM_SERVICE);
                am.cancel(sender);
                Toast.makeText(Clock.this,"闹钟时间删除",
    ...
    public boolean onKeyUp(int keyCode, KeyEvent event) {
        ...
        if(keyCode == KeyEvent.KEYCODE_BACK){
            mediaPlayer.stop();
            builder = new AlertDialog.Builder(Clock.this)

                    .setTitle("温馨提示：")
                    .setMessage("您是否要退出闹钟设置？")
