package com.example.com.example.historicaltrack;
...
import com.example.com.example.electronicfence.TrackApplication;
import com.example.com.example.historicaltrack.utils.BitmapUtil;
...
public class HistoricaltrackActivity extends BaseActivity {
    ...
    public class SDKReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_ERROR)) {
                Toast.makeText(HistoricaltrackActivity.this,"apikey验证失败，地图功能无法正常使用",Toast.LENGTH_SHORT).show();
            } else if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_OK)) {
                Toast.makeText(HistoricaltrackActivity.this,"apikey验证成功",Toast.LENGTH_SHORT).show();
            } else if (s.equals(SDKInitializer.SDK_BROADCAST_ACTION_STRING_NETWORK_ERROR)) {
                Toast.makeText(HistoricaltrackActivity.this,"网络错误",Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void init() {
        ...
        trace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HistoricaltrackActivity.this, TracingActivity.class);
    ...
    protected int getContentViewId() {
        return R.layout.activity_historicaltrack;
    }
