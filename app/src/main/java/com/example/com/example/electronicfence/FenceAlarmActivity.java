...
public class FenceAlarmActivity extends BaseActivity implements View.OnClickListener, SensorEventListener, BaiduMap.OnMarkerClickListener {
    ...
    private void initTrace() {
        ...
        mTrace = new Trace(trackApp.serviceId, trackApp.entityName,true);
        locRequest = new LocRequest(trackApp.serviceId);//本地定位请求
    ...
    private void initListener() {
        ...
        createCallback = new FenceCreateDialog2.Callback() {
            ...
            public void onSureCallback(double radius, int denoise, int offset) {
                ...
                //创建围栏
                CreateFenceRequest request = CreateFenceRequest.buildServerCircleRequest(trackApp.getTag(), trackApp.serviceId, "huawei",
        ...
        traceListener = new OnTraceListener() {
            ...
            public void onPushCallback(byte messageType, PushMessage pushMessage) {
                ...
                NotificationCompat.Builder builder= new NotificationCompat.Builder(FenceAlarmActivity.this,CHANNEL_ID);
                builder
                        .setContentIntent(pi)
